...
| HAZ-005 | Disk / Memory Exhaustion | Client requests generation of unbounded number of DICOM instances. | High | High | Design Control: Pydantic Field(ge=1, le=1024) clamps maximum allowed instance count per generation request, supporting high-volume stress testing up to 1024 slices. | Negligible | Boundary validation tests on num_instances. |
